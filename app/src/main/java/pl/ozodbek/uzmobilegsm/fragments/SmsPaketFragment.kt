...
import pl.ozodbek.uzmobilegsm.databinding.FragmentSmsPaketBinding
...
class SmsPaketFragment : Fragment() {
    ...
    private var _binding: FragmentSmsPaketBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSmsPaketBinding.inflate(inflater, container, false)

        binding.upButton.setOnClickListener {
            findNavController().navigate(R.id.action_smsPaketFragment_to_homeFragment)
